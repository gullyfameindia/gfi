...
import { requestAudioPermissionsAsync, setAudioModeAsync } from 'expo-audio';
...
export { Speech };
export type { AudioTrackWithEffects, VoiceOverlayWithEffects, AudioEffectType, TextToSpeechConfig, AudioMixSettings };
